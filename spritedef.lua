...
SDEF = { 
    ...
    { 30, 40, 5, 11, 1, 1, 0, 0, 0 }, -- 14. warn sign
    { 35, 40, 5, 11, 1, 1, 0, 0, 0 }, -- 15. diamond sign
    { 40, 40, 5, 11, 1, 1, 0, 0, 0 }, -- 16. diamond sign back
    { 45, 40, 12, 8, 1, 1, 0, 0, 0 }, -- 17. chevron r (red)
    { 45, 40, 12, 8, 1, 1, 1, 0, 0 }, -- 18. chevron l (red)
...
SPDEF = {
    { { 1, 3, 0, -1.6, -1.6, 0 }, { 4, 2,0, 2, 8, 1 }, { 3, 1,0, 1.5, 2, 1 }  }, --  1. <green> chevron r, trees, grass
    { { 2, 3,0, 1.6, 1.6, 0 }, { 4, 2,0, 2, 8, 1 }, { 3, 1,0, 1.5, 2, 1 }  }, --  2. <green> chevron l, trees, grass
